...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // (Rúbrica 2.3, 2.4)
        ArrayList<Empleado> empleados = cargarEmpleados(Paths.get(DIR_EMPLEADOS, "empleados.dat").toFile());//Para cargar los datos utilizare funciones que devuelvan Objetos
        ...
        List<Plantas> plantas = cargarPlantasDesdeXML(Paths.get(DIR_PLANTAS,"plantas.xml").toFile());//Paths == Para pasar rutas
        if (plantas == null) {
        ...
        if (logeado.getCargo().equalsIgnoreCase("vendedor")) {
            ...
            ArrayList<Empleado> empleadosBaja = cargarEmpleados(Paths.get(DIR_EMPLEADOS, "BAJA", "empleadosBaja.dat").toFile());
    ...
    /**
     * Lee empleados desde empleados.dat 
     * (Rúbrica 2.3, 2.4)
     */
     ...
     * (Rúbrica 2.1)     * @param lista La lista de plantas ACTIVAS.
     */
    ...
    /**
     * Lee SÓLO el stock de una planta en plantas.dat (acceso directo).     * @return El stock (int), o 0 si hay error.
     */
     ...
     * (Rúbrica 4.1)     * @param listaPlantas La lista de plantas activas (cargada del XML).
     */
    ...
    /**
     * Muestra la ficha detallada de una planta (nombre, desc, precio, stock).     * @param p La planta a mostrar.
     */
     ...
     * (Rúbrica 8.1.1)     * @param activas La lista de plantas activas (se modificará).
     */
